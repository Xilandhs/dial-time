...
export default function ProductDetailModal({ product, onClose, onAddToCart }: ProductDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-0 sm:p-6 md:p-10 overflow-y-auto">
      {/* Backdrop */}
      <div 
      ...
      {/* Modal Card */}
      <div className="relative w-full max-w-4xl bg-[#FAF8F5] sm:rounded-3xl overflow-hidden shadow-2xl border border-[#0F2A4A]/10 z-10 animate-in fade-in zoom-in-95 duration-200 my-0 sm:my-8">
        {/* Close Button */}
        <button
          onClick={onClose}
